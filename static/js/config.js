...
// Boost mechanics
export const BOOST_SPEED_MULTIPLIER = 2.5; // Speed multiplier while boosting
export const BOOST_DURATION = 1500;        // Duration of boost burst in ms
export const BOOST_COOLDOWN = 5000;        // Cooldown after boost ends in ms
